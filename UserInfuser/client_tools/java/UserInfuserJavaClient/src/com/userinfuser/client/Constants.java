...
public class Constants {
    ...
    public static final String PATH = "http://mattosgamification.appspot.com/api/";
    public static final String PATH_SECURE = "https://mattosgamification.appspot.com/api/";
